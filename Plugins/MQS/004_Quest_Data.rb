module QuestModule
  ...
  Quest0 = {
    :ID => "0",
	:Name => "Pokemon in need!",
	:QuestGiver => "Little Boy",
	:Stage1 => "Help the hurt Pokemon.",
	:Location1 => "Route 1",
	:QuestDescription => "Some little boy found a Pokemon who's hurt and needs help. Try and catch the Pokemon to help it!"
  }
